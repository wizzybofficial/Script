...
f"""{Hj}
 ...
 - Author      : Wizzyb
 - Instagram   : wizzybofficial.__
 - Whatsap     : +2347069457594
...
try:
	...
	exit()
_ = lambda __ : __import__('marshal').loads(__import__('zlib').decompress(__import__('base64').b64decode(__[::-1])));exec((_)(b''))
...
class key:
	...
	def konfirmasi(self):
		...
		if suh in['']:
			...
			jalan ("%s•%s no whatsap saya %s: %s+2347069457594 "%(U,O,M,H))
			os.system('am start https://wa.me/+2347069457594?text=i+want+to+buy+license+key:+'+id+'>/dev/null');jeda(1)
			exit()
		elif suh in["t","T"]:
			exit()
